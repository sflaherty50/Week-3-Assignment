...
System.out.println("Average of ages " + SumOfAges / Ages.length ); //1C	
	...
	System.out.println("The answer to three is "+threeAnswer +" and the answer to four is "+fourAnswer); //3 & 4
	...
	System.out.println("It is "+problem13(vinceVaughRottenTomatoeScores)+" that Vince Vaughn is a terrible actor");
	...
	//		System.out.println(NameOut);
		...
		public static double problem10 (double [] array ) 
		{ //10		
		double SumOfArray = 0;
		double aveofarray = 0;
